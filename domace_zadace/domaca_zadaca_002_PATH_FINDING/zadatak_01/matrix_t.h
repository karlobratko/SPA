...
class matrix_t {
public:
	explicit matrix_t(std::size_t col) : matrix_t{ col, col } {};
	explicit matrix_t(std::size_t col, std::size_t row) :
		col_{ col },
		row_{ row } {
